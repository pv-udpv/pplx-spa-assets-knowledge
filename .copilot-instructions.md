...
- **[KNOWLEDGE_BASE.md](KNOWLEDGE_BASE.md)** - Complete catalog of project artifacts, statistics, and usage examples
- **[knowledge_base_meta.json](knowledge_base_meta.json)** - Machine-readable project metadata for programmatic access
