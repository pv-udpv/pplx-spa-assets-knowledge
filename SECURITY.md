...
https://github.com/pv-udpv/pplx-spa-assets-knowledge/security/advisories/new

For issues affecting multiple repos in the `pv-udpv` org, use the advisory
above and note the impacted repositories in your report rather than filing a
public issue.
